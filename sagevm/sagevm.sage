# sagevm/sagevm.sage - SageVM port (single-file authoritative VM).
#
# Synced from ~/Devel/SageVM/sagevm_standalone.sage (github
# Night-Traders-Dev/SageVM) at the 2026-08-12 main snapshot (file banner v0.9.9,
# Do not edit by hand for features; refresh the copy and re-run the
# conformance suite (upstream tools/parity_check.py).
#
